            ...
            <div className="text-center md:text-left space-y-3">
              ...
              <div className="flex justify-center md:justify-start space-x-4 pt-2">
               ...
               <a
                ...
                {/* LinkedIn */}
                <a
                  href="https://www.linkedin.com/in/atelier-trentacinque-617061364?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-300 hover:text-white"
                  aria-label="LinkedIn"
                >
                  ...
                  >
                    <path
                      d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.761 0 5-2.239 5-5v-14c0-2.761-2.239-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.268c-.966 0-1.75-.79-1.75-1.764 0-.974.784-1.764 1.75-1.764s1.75.79 1.75 1.764c0 .974-.784 1.764-1.75 1.764zm13.5 11.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-10h3v1.604c1.396-2.586 7-2.777 7 2.476v5.92z"
                    />
                  </svg>
                </a>
              </div>
